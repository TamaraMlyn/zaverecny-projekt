...
export const Registration = () => {
  return (
    <div className="registration__container">
      ...
      <div className="registration__intro">Od dobrovolnictví Vás už dělí jenom pár kroků!</div>
      <form>
        ...
        <label className="label label__checkbox">
          <input className="checkbox" type="checkbox" checked name="podmínky"/> 
        ...
        <div type="submit" className="btn primary">Registrovat</div>
        </form>
        <div className="registration__account-created">Už máte účet? 
          <a href="sign-in.html">
          Přihlašte se </a></div>
</div>
  )
