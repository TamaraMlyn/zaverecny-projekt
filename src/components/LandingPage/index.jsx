          ...
          <div className="intro__content">
            <div className="intro__info">
              ...
              <p className="intro__text">
                Propojujeme lidi na vozíku s dobrovolníky, aby byl pohyb po městě
                jednodušší.
                <br />
            ...
            <div className="rules__person">
              ...
              <div className="person__description">
                ...
                <p>
                  ...
                  data, lokality, časového intervalu a účelu doprovodu. Na základě požadavku ho pak
                  kontaktuje dobrovolník, který požadavkům dokáže vyhovět.
                </p>
              </div>
            </div>
            ...
            <div className="rules__person">
              ...
              <div className="person__description">
                ...
                <p>
                  ...
                  požadavky na asistenci. Na základě svých možností vybírá,
                  komu může vyhovět a následně reaguje na poptávku.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="about container">
          <div className="about__description">
            ...
            <p className="about__text">
              ...
              bezbariérová. I síť městské hromadné dopravy, navzdory všem snahám, 
              úplně bezbariérová stále není. Dopravit se na
              určité místo proto dokáže být pro některé lidi na vozíku často problém. 
              Ti potřebují v těchto situacích asistenci, kterou mohou nabídnout dobrovolníci.
              Dobrovozík se snaží o jejich propojení.
            </p>
            <p className="about__text">
              Hlavním cílem Dobrovozíku je zefektivnění a zjednodušení propojení lidí
              na vozíku s dobrovolníky pro účely jednorázové asistence. Především se jedná o 
              doprovod na určité místo a v určitý čas, prostřednictvím městské hromadné dopravy. 
              Kromě jiného by měl projekt podpořit dobrovolnictví v této oblasti.
              Může pomoct rozšířit síť dobrovolníků a zjednodušit cestu, jak se dobrovolníkem stát.
              Dobrovozík pracuje s myšlenkou, že by město mohlo do budoucna dobrovolníky odměňovat za jejich pomoc
              například tím, že jim za určitý počet asistencí zlevní nákup kupónů MHD. 
              Časem může aplikace sloužit i k identifikaci těch pro vozíky nejvíce problematických míst v jednotlivých městech.
            </p>
          </div>
        </div>
      </div>
